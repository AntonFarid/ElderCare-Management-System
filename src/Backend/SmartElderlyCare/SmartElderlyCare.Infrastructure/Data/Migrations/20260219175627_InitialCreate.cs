        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AiGeneratedReport = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DailyReports_Elderlies_ElderlyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanScheduleVisits = table.Column<bool>(type: "bit", nullable: false),
                    Id = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ElderlyFamilyMembers", x => new { x.ElderlyId, x.FamilyMemberId });
                    table.ForeignKey(
                        name: "FK_ElderlyFamilyMembers_Elderlies_ElderlyId",
                        column: x => x.ElderlyId,
                        principalTable: "Elderlies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ElderlyFamilyMembers_Users_FamilyMemberId",
            ...
            migrationBuilder.CreateTable(
                name: "EmployeeElderlyAssignments",
                columns: table => new
                {
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                    ElderlyId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeElderlyAssignments", x => new { x.EmployeeId, x.ElderlyId });
                    table.ForeignKey(
                        name: "FK_EmployeeElderlyAssignments_Elderlies_ElderlyId",
                        column: x => x.ElderlyId,
                        principalTable: "Elderlies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmployeeElderlyAssignments_Users_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VisitRequests_Elderlies_ElderlyId",
                        column: x => x.ElderlyId,
                        principalTable: "Elderlies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VisitRequests_Users_ApprovedById",
                        column: x => x.ApprovedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VisitRequests_Users_FamilyMemberId",
                        column: x => x.FamilyMemberId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RecordedTime = table.Column<TimeSpan>(type: "time", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HealthMetrics_DailyReports_DailyReportId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyReports_ElderlyId",
                table: "DailyReports",
                column: "ElderlyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyReports_IsDeleted",
                table: "DailyReports",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Elderlies_IsDeleted",
                table: "Elderlies",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_ElderlyFamilyMembers_FamilyMemberId",
                table: "ElderlyFamilyMembers",
                column: "FamilyMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeElderlyAssignments_ElderlyId",
                table: "EmployeeElderlyAssignments",
                column: "ElderlyId");

            migrationBuilder.CreateIndex(
                name: "IX_HealthMetrics_DailyReportId",
                table: "HealthMetrics",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VisitRequests_ApprovedById",
                table: "VisitRequests",
                column: "ApprovedById");

            migrationBuilder.CreateIndex(
                name: "IX_VisitRequests_ElderlyId",
                table: "VisitRequests",
                column: "ElderlyId");

            migrationBuilder.CreateIndex(
                name: "IX_VisitRequests_FamilyMemberId",
                table: "VisitRequests",
                column: "FamilyMemberId");
