...
export default function TeamLeaderProfile() {
    ...
    const fetchProfile = async () => {
        setIsLoading(true);
        try {
            const response = await apiServices.getProfile('TeamLeader');
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            await apiServices.updateProfile('TeamLeader', payload);
            addToast({
                title: "Success",
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-500 mt-1 text-sm">
                        View and manage your team leader account details.
                    </p>
                </div>
                {!isLoading && (
                    <Button
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-4">
                        {isLoading ? (
                            ...
                            <Avatar
                                ...
                                className="w-24 h-24 text-2xl font-bold border-4 border-white dark:border-gray-900 shadow-md bg-gradient-to-br from-blue-500 to-blue-700 text-white"
                                showFallback
                            />
                        )}
