...
export default function TeamLeaderNavbar() {
    ...
    const navigationItems = [
        ...
        { name: 'Residents', path: '/teamleader/residents' },
        { name: 'Employees', path: '/teamleader/employees' },
        ...
        <nav className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    {/* Logo */}
                    <Link to="/teamleader/dashboard" className="flex items-center gap-3">
                    ...
                    <div className="hidden md:flex items-center gap-4">
                        <button 
                            onClick={() => navigate('/teamleader/notifications')}
